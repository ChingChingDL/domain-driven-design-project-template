...
import world.snowcrystal.template.domain.favorite.dto.query.PostFavouriteQuery;
...
public class FavouriteQueryService {
    ...
    public Long countUserFavour(world.snowcrystal.template.domain.favorite.dto.query.UserFavouriteQuery userFavouriteQuery) {
        return favouriteRepository.countUserFavours(Id.of(userFavouriteQuery.getUserId()));
    }

    public List<Favourite> listUserFavours(world.snowcrystal.template.domain.favorite.dto.query.UserFavouriteQuery userFavouriteQuery) {
