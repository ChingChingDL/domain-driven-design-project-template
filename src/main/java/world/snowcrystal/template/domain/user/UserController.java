...
public class UserController {
     ...
     */
    @GetMapping("/{userId}")
    public ApplicationResponse<UserVO> getUserVOById(@PathVariable("userId") @Nonnull @Min(0) Long userId) {
     ...
     */
    @PostMapping("/list")
    public ApplicationResponse<Page<UserVO>> listUserVOByPage(@Nonnull
                                                              @RequestBody
